...
| `/rebase-issue <target>` | Rebase an issue branch onto origin/main after upstream PRs merge — handles conflicts, squashes to one commit, and confirms before push |
