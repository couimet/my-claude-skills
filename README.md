...
| `/set-work-folder <folder> [name]`                             | Point this session's working files at a folder instead of letting the current git branch decide — `--clear` restores branch-derived placement                                                                       |
