...
| `/cleanup-issue [number \| --sweep]` | Delete an issue's working directory (`.claude-work/issues/<ID>/`) after confirming with the user, or sweep all obsolete folders whose PRs merged into main or whose issues closed |
