...
| `/launch-agent <folder> [--name <name>] <prompt>`              | Dispatch a background agent with its topic folder created, its launch prompt saved inside it, and its display name set, all in one call                                                                             |
