...
Before creating the issue, append a footer line to the body file identifying the skill that generated it. Read the `version:` field from this SKILL.md's front matter to fill `<VERSION>`. Use the Edit tool to append to the body file:
