...
| Form                    | Syntax         | Example                                                      |
| ----------------------- | -------------- | ------------------------------------------------------------ |
| Step-ID (preferred)     | `path#S00N`    | `.claude-work/issues/42/scratchpads/<plan-file>.txt#S003`    |
| Line-range              | `path#L10-L20` | `.claude-work/issues/42/scratchpads/<plan-file>.txt#L25-L67` |
| Space-separated         | `path S00N`    | `.claude-work/issues/42/scratchpads/<plan-file>.txt S003`    |
| Bare path (auto-select) | `path`         | `.claude-work/issues/42/scratchpads/<plan-file>.txt`         |
