...
Footer: `Generated by /finish-issue v<VERSION> • [my-claude-skills](https://github.com/couimet/my-claude-skills)` as the last content line. Read `<VERSION>` from this SKILL.md's front matter `version:` field. This replaces the default `🤖 Generated with [Claude Code]` — do not add both.
