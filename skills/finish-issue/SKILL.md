...
allowed-tools: Read, Write, Glob, Grep, AskUserQuestion, Bash(git branch --show-current), Bash(git status), Bash(git log *), Bash(git diff *), Bash(make lint-fix *), Bash(make test *), Bash(mkdir -p *), Bash(date *), Bash(*/skills/issue-context/branch-issue-id.sh *), Bash(*/skills/issue-context/resolve-issue-id.sh *), Bash(*/skills/issue-context/get-issue-folder-path.sh *), Bash(*/skills/issue-context/target-path.sh *), Bash(*/skills/issue-context/claude-work-root.sh *), Bash(*/skills/question/extract-answers.sh *), Bash(*/skills/prose-style/check-prose.sh *), Bash(*/skills/issue-context/skill-version.sh *)
---
...
Otherwise resolve the identifier from the current branch. See `/issue-context-internals` for the contracts of the identifier and folder scripts. Run the gate alongside `git branch --show-current` (the raw branch name is needed for side-quest detection and error reporting):
...
Generated by /finish-issue v<VERSION> • [my-claude-skills](https://github.com/couimet/my-claude-skills)
```
...
Footer: `Generated by /finish-issue v<VERSION> • [my-claude-skills](https://github.com/couimet/my-claude-skills)` as the last content line, preceded by a blank line. Read `<VERSION>` from `skill-version.sh finish-issue`. This replaces the default `🤖 Generated with [Claude Code]`. Do not add both.
...
- [ ] Skill footer line present (read `<VERSION>` from `skill-version.sh finish-issue`)
