...
Fill `<VERSION>` from this SKILL.md's front matter `version:` field. This footer replaces the default `🤖 Generated with [Claude Code](https://claude.com/claude-code)` line. Do not add both. The skill footer is the sole attribution.
...
Footer: `Generated by /finish-issue v<VERSION> • [my-claude-skills](https://github.com/couimet/my-claude-skills)` as the last content line, preceded by a blank line. Read `<VERSION>` from this SKILL.md's front matter `version:` field. This replaces the default `🤖 Generated with [Claude Code]`. Do not add both.
...
- [ ] Skill footer line present (read `<VERSION>` from this SKILL.md's front matter `version:` field)
